...
function pyramid(points_transform) {
	shape.call(this);
	points_transform = points_transform || mat4();
...
pyramid.prototype.populate = function (recipient, points_transform) {
	this.vertices.push(
	vec3(-1,0,1), vec3(1,0,1), vec3(0,2,0), //front face
	vec3(-1,0,-1), vec3(1,0,-1), vec3(0,2,0), //back face
	vec3(1,0,1), vec3(1,0,-1), vec3(0,2,0), //right face
	vec3(-1,0,1), vec3(-1,0,-1), vec3(0,2,0), //left face
	vec3(1,0,-1), vec3(-1,0,1), vec3(1,0,1), //1st half bottom
	vec3(-1,0,1), vec3(1,0,-1), vec3(-1,0,-1) //2nd half bottom
	);
	recipient.normals = [
		vec3(0, .5, 1),vec3(0, .5, 1),vec3(0, .5, 1),
		vec3(0, .5, -1),vec3(0, .5, -1),vec3(0, .5, -1),
		vec3(1, .5, 0),vec3(1, .5, 0),vec3(1, .5, 0),
		vec3(-1, .5, 0),vec3(-1, .5, 0),vec3(-1, .5, 0),
		vec3(0, -1, 0),vec3(0, -1, 0),vec3(0, -1, 0),
		vec3(0, -1, 0),vec3(0, -1, 0),vec3(0, -1, 0)
	];
	
	recipient.texture_coords.push(vec2(0, 0), vec2(1, 0), vec2(1, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(1, 0), vec2(1, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(1, 0), vec2(1, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(0, 1), vec2(1, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(0, 1), vec2(1, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(0, 1), vec2(1, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(1, 0), vec2(1, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(1, 0), vec2(1, 1));
	...
	recipient.texture_coords.push(vec2(0, 0), vec2(1, 0), vec2(1, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(1, 0), vec2(1, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(1, 0), vec2(0, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(1, 0), vec2(0, 1));
	recipient.texture_coords.push(vec2(0, 0), vec2(1, 0), vec2(0, 1));
